...
public class dataHolder implements Serializable {
	...
	private String correct_path = "/bbs_logic_generator/test/loginResult.jsp"; 
	//경로명은 나중에 processHTML.java 완성할때까지 하드코딩으로 이렇게 둔다. 밑에 나머지도 마찬가지
	private boolean id_error_check;
	private String id_error_path = "/bbs_logic_generator/test/loginResult2.jsp";
	
	private boolean pw_error_check;
	private String pw_error_path = "/bbs_logic_generator/test/loginResult2.jsp";
	
	private boolean db_error_check; //만약 체크 안되어 있을 경우, 원래 페이지로 리다이렉트 되도록 한다. 
	private String db_error_path = "/bbs_logic_generator/test/loginResult2.jsp";
	...
	//==================getter/setter 모음========================
	  public String getId() {
		...
		public void setCorrect_path(String correct_path) {
			...
			//this.correct_path = "/bbs_logic_generator/test/" + correct_path;
		}
		...
		public void setId_error_path(String id_error_path) {
			//this.id_error_path = "/bbs_logic_generator/test/" + id_error_path;
		...
		public void setPw_error_path(String pw_error_path) {
			//this.pw_error_path = "/bbs_logic_generator/test/" + pw_error_path;
		...
		public void setDb_error_path(String db_error_path) {
			//this.db_error_path = "/bbs_logic_generator/test/" + db_error_path;
